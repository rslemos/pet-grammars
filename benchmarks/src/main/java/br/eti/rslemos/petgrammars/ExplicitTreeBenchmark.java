...
public class ExplicitTreeBenchmark {

	public enum Source {
		TOPLEVELONLY(ExplicitTreeUnitTest.join(
				"1 node-0",
				"1 node-00",
				"1 node-000",
				"1 node-001",
		...
		DEEPTREE(ExplicitTreeUnitTest.join(
				"1 node-0",
				"2 node-00",
				"3 node-000",
				"3 node-001",
		...
		VERYLONGTREE(ExplicitTreeUnitTest.join(
				"1 node-1",
				"1 node-2",
				"1 node-3",
				"1 node-4",
		...
		VERYDEEPTREE(ExplicitTreeUnitTest.join(
				"1 node-1",
				"2 node-2",
				"3 node-3",
				"4 node-4",
	...
	public RootContext compile() {
		ExplicitTreeParser parser = ExplicitTreeParser.getParser(source.text);
	...
	public static void main(String[] args) throws Exception {
		Options opts = new OptionsBuilder()
			.include(ExplicitTreeBenchmark.class.getSimpleName())
			.forks(1)
